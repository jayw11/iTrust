...
<%
	...
	if (price != null && !"null".equals(value)) {
		...
		Integer rPrice = (Integer)cm.getRecipes()[recipeNum].getPrice();
		Integer uCoffee = (Integer)cm.getRecipes()[recipeNum].getAmtCoffee();
		Integer uMilk = (Integer)cm.getRecipes()[recipeNum].getAmtMilk();
		Integer uSugar = (Integer)cm.getRecipes()[recipeNum].getAmtSugar();
		Integer uChocolate = (Integer)cm.getRecipes()[recipeNum].getAmtChocolate();
...
<table>
<tr>
<td><input type="text" name="price" value="<%=rPrice%>"></td><td><span class="font1">Recipe Price (integer)</span></td>
</tr>
<tr>
<td><input type="text" name="amtCoffee" value="<%=uCoffee%>"></td><td><span class="font1">Units Coffee</span></td>
</tr>
<tr>
<td><input type="text" name="amtMilk" value="<%=uMilk%>"></td><td><span class="font1">Units Milk</span></td>
</tr>
<tr>
<td><input type="text" name="amtSugar" value="<%=uSugar%>"></td><td><span class="font1">Units Sugar</span></td>
</tr>
<tr>
<td><input type="text" name="amtChocolate" value="<%=uChocolate%>"></td><td><span class="font1">Units Chocolate</span></td>
</tr>
</table>
