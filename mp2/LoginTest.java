...
public class LoginTest extends iTrustSeleniumTest {
	...
	public void testResetPassword() throws Exception {
		WebDriver wd = login("2", "pw");

		wd.get("http://fa19-cs427-150.cs.illinois.edu:8080/iTrust");

		WebElement element;
		element = wd.findElement(By.linkText("Reset Password"));
		element.click();
		...
		element = wd.findElement(By.name("mid"));
		element.sendKeys("1");
		element.submit();

		assertTrue(wd.getPageSource().contains("what is your favorite color?"));
		element = wd.findElement(By.name("answer"));
		element.sendKeys("blue");
		element = wd.findElement(By.name("password"));
		element.sendKeys("newPw12345");
		element = wd.findElement(By.name("confirmPassword"));
		element.sendKeys("newPw12345");
		element.submit();
