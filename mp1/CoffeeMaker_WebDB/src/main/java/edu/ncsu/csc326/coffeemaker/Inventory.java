...
public class Inventory {
    ...
    public int getChocolate() {
        //return chocolate;
        return InventoryDB.getChocolate();
    }
    ...
    public synchronized void setChocolate(int chocolate) {
    	if(chocolate >= 0) {
            InventoryDB.setChocolate(chocolate);
    ...
    public synchronized void addChocolate(String chocolate) throws InventoryException {
		...
		if (amtChocolate >= 0) {
            ...
            setChocolate(getChocolate()+amtChocolate);
		} else {
			throw new InventoryException("Units of chocolate must be a positive integer");
		}
    }
    ...
    public String toString() {
    	...
    	buf.append("Coffee: ");
    	String coffee = String.valueOf(getCoffee());
    	buf.append(coffee);
    	buf.append("\n");
    	buf.append("Milk: ");
    	buf.append(String.valueOf(getMilk()));
    	buf.append("\n");
    	buf.append("Sugar: ");
    	buf.append(String.valueOf(getSugar()));
    	buf.append("\n");
    	buf.append("Chocolate: ");
    	buf.append(String.valueOf(getChocolate()));
    	buf.append("\n");
    	return buf.toString();
    }
}
